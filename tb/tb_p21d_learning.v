...
module tb_p21d_learning;
    ...
    initial begin
        ...
        prog_param(0, 50, 4'd3, 16'sd0);
        prog_param(0, 50, 4'd11, 16'sd8);
        prog_param(0, 50, 4'd13, 16'sd2);
        prog_param(0, 50, 4'd14, 16'sd50);

        do_probe(0, 50, 4'd1, 0);
        probed_thr = $signed(probe_data);
        $display("  Initial threshold of neuron 50 = %0d", probed_thr);

        inject(0, 50, 16'sd1500); run_timestep;
        inject(0, 50, 16'sd1500); run_timestep;
        inject(0, 50, 16'sd1500); run_timestep;
        inject(0, 50, 16'sd1500); run_timestep;
        inject(0, 50, 16'sd1500); run_timestep;
        ...
        prog_param(0, 60, 4'd13, 16'sd2);
        prog_param(0, 60, 4'd14, 16'sd30);
